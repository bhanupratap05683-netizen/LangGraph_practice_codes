...
if __name__ == "__main__":
    sample_resume = """
    Aman Sharma
    aman.sharma@example.in | +91 98765 43210 | Bangalore, India

    SUMMARY
    Financial Data Analyst with 4+ years of experience working with financial modeling, 
    quantitative reports, and automated ETL pipelines using Python and Excel.

    WORK EXPERIENCE
    Senior Quantitative Analyst - Capital Alpha (May 2023 - Present)
    - Developed risk assessment models and automated portfolio rebalancing.
    
    Data Analyst - Quantify Analytics (Jan 2021 - Apr 2023)
    - Built SQL dashboards, analyzed stock metrics, and managed client datasets.

    Junior Financial Analyst - Growth Edge (July 2020 - Dec 2020)
    - Maintained automated Excel spreadsheets and cleaned raw market data.

    EDUCATION
    Bachelor of Commerce (B.Com) - Bangalore University (2017 - 2020)

    SKILLS
    Python, Pandas, Advanced Excel, SQL, Financial Modeling, PowerBI, Quantitative Analysis
    """
